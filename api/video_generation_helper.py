...
command = f'scp "{target_path}/outputs/selected.json" azureuser@172.206.3.169:/home/azureuser/videocreation/api/outputs'
...
command = f'scp "{target_path}/outputs/subtitle.txt" azureuser@172.206.3.169:/home/azureuser/videocreation/api/outputs'
process = subprocess.Popen(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
command = f'scp "{target_path}/outputs/readyScript.txt" azureuser@172.206.3.169:/home/azureuser/videocreation/api/outputs'
process = subprocess.Popen(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
for file in files_to_copy:
    command = f'scp azureuser@172.206.3.169:/home/azureuser/videocreation/api/outputs/{file} "{target_path}/outputs/"'
    process = subprocess.Popen(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout, stderr = process.communicate()
...
print(target_path   )
if DOCKER:
    command = f'scp azureuser@172.206.3.169:/home/azureuser/videocreation/public/final.mp4 "{target_path}/public/"'
    process = subprocess.Popen(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout, stderr = process.communicate()
    ...
    command = f'scp azureuser@172.206.3.169:/home/azureuser/videocreation/public/final.mp4 "{cd}/public/"'
    process = subprocess.Popen(command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout, stderr = process.communicate()

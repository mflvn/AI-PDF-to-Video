...
def text_to_speech(subtitles, voice_choice, current_directory, tts_api_key):
    ...
    female_gb_voice_id = 'pFZP5JQG7iQjIQuC4Bku'
    male_gb_voice_id = 'onwK4e9ZLuTAKqWW03F9'
    female_us_voice_id = 'pFZP5JQG7iQjIQuC4Bku'
    male_us_voice_id = 'onwK4e9ZLuTAKqWW03F9'
